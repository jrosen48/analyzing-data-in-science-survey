...
list(
  tar_target(data_mailing_list, read_csv(here("data", "analyzing-data-in-science-mailing-lists-response-options.csv"))),
  ...
  tar_target(data_social_media, read_csv(here("data", "analyzing-data-in-science-social-media-response-options.csv"))),
  ...
  tar_target(data_social_media_processed, mutate(data_social_media_sliced, collection = "social-media")),
